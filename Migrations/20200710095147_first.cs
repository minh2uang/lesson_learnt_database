        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abstract = table.Column<string>(maxLength: 200, nullable: false),
                    Organization = table.Column<string>(maxLength: 50, nullable: true),
                    DateStart = table.Column<DateTime>(nullable: false),
                    DateEnd = table.Column<DateTime>(nullable: false),
                    Budget = table.Column<decimal>(nullable: false),
                    Size = table.Column<int>(nullable: false),
                    ObjectiveAchievement = table.Column<string>(nullable: true),
                    LessonsLearned = table.Column<string>(maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rating", x => new { x.LessonId, x.IdentityUserId });
                    table.UniqueConstraint("AK_Rating_IdentityUserId_LessonId", x => new { x.IdentityUserId, x.LessonId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rating_Lesson_LessonId",
                        column: x => x.LessonId,
